...
section3_themes = ["3.1. Общие правила приближения", "Метод Лагранжа", "Метод Ньютона", "Погрешность многочленной аппроксимации", "Тема 3.2.4",
                   "Тема 3.2.5", "Тема 3.3", "Тема 3.4", "Тема 3.4.1", "Тема 3.4.2", "Тема 3.4.3", "Тема 3.4.4"]
