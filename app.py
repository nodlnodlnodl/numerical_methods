...
section6_themes = ["6.1.1. Треугольные матрицы", "6.1.2. Унитарные матрицы", "6.2. Нормы векторов и матриц",
                   "6.3. Обусловленность линейной системы", "6.4. Прямые методы решения систем линейных уравнений",
                   "6.4.1. Метод исключения Гаусса", "6.4.2. Метод отражений", "6.4.3. Метод ортогонализации",
