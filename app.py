...
section3_themes = ["3.1. Общие правила приближения", "3.2.1. Метод Лагранжа", "3.2.2. Метод Ньютона",
                   ...
                   "3.2.5. Многочлены Чебышева", "3.3 Интерполяция сплайнами", "3.4 Среднеквадратичное приближение(метод наименьших квадратов)", "3.4.1 Дискретное задание функции, многочленная аппроксимация", "3.4.2 Непрерывно задание функции, линейная аппроксимация",
                   "3.4.3 Ортогональные функции", "Тема 3.4.4"]
section4_themes = ["4.1 Численное дифференцирование",
                   ...
                   "4.2.5.3. Метод Филона", "Тема 4.2.5.4.", "Тема 4.2.6.", "Тема 4.2.6.1.", "Тема 4.2.6.2.", "Тема 4.2.7"]
...
# 4.2.4. Повышение точности квадратурных формул
    ...
    improving_the_accuracy_of_quadrature_formulas()
...
# 4.2.5.1. Разрывные функции
    ...
    discontinuous_functions_integration()
