...
section3_themes = ["3.1. Общие правила приближения", "3.2.1. Метод Лагранжа", "3.2.2. Метод Ньютона", "3.2.3. Погрешность многочленной аппроксимации", "3.2.4. Трудности приближения многочленом",
                   "3.2.5. Многочлены Чебышева", "Тема 3.3", "Тема 3.4", "Тема 3.4.1", "Тема 3.4.2", "Тема 3.4.3", "Тема 3.4.4"]
