...
# 6.5. Итерационные методы решения линейных систем
elif selected_theme == "6.5. Итерационные методы решения линейных систем":
    iterative_methods_linear_systems()
...
# 11.2.4. Устойчивость методов Рунге–Кутты. Недостатки явных методов Рунге–Кутты
elif selected_theme == "11.2.4. Устойчивость методов Рунге–Кутты. Недостатки явных методов Рунге–Кутты":
    stability_runge_kutta_methods()
