...
section3_themes = ["3.1. Общие правила приближения", "Метод Лагранжа", "Метод Ньютона", "Погрешность многочленной аппроксимации", "Трудности приближения многочленом",
                   "Многочлены Чебышева", "Тема 3.3", "Тема 3.4", "Тема 3.4.1", "Тема 3.4.2", "Тема 3.4.3", "Тема 3.4.4"]
section4_themes = ["Тема 4.1", "Тема 4.1.1", "Тема 4.1.2.", "Тема 4.2.", "Тема 4.2.1.", "Тема 4.2.2.", "Тема 4.2.3.",
                   "Тема 4.2.4.", "Тема 4.2.5.", "Тема 4.2.5.1.", "Тема 4.2.5.2.", "Тема 4.2.5.3.", "Тема 4.2.5.4.",
                   "Тема 4.2.6.", "Тема 4.2.6.1.", "Тема 4.2.6.2.", "Тема 4.2.7"]
...
elif selected_theme == "Погрешность многочленной аппроксимации":
    error_of_polynomial_interpolation()
    code_editor()

elif selected_theme == "Трудности приближения многочленом":
    polynomial_approximation_difficulties()

elif selected_theme == "Многочлены Чебышева":
